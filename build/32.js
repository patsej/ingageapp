...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__site_help__ = __webpack_require__(2215);
...
var CoreLoginSiteHelpPage = /** @class */ (function () {
    ...
    CoreLoginSiteHelpPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-login-site-help',template:/*ion-inline-start:"/media/pat/DATA/Belinguo/Dev/moodlemobile2/src/core/login/pages/site-help/site-help.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ \'core.login.help\' | translate }}</ion-title>\n\n        <ion-buttons end>\n            <button ion-button icon-only (click)="closeHelp()" [attr.aria-label]="\'core.close\' | translate">\n                <ion-icon name="close"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content padding>\n    <core-format-text [text]="\'core.login.helpmelogin\' | translate" [filter]="false"></core-format-text>\n</ion-content>\n'/*ion-inline-end:"/media/pat/DATA/Belinguo/Dev/moodlemobile2/src/core/login/pages/site-help/site-help.html"*/,
        }),
